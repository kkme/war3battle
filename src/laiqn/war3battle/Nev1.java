...
public class Nev1 extends Activity {
	...
	public void clickv1(View view) {
		...
		if(random % 8 ==0){
			displayToast("恭喜你随机到：1本TR人族！");
		}
		if(random % 8 ==1){
			displayToast("恭喜你随机到：2本RUSH人族！");
		}
		if(random % 8 ==2){
			displayToast("恭喜你随机到：后期雄鹿！");
		}
		if(random % 8 ==3){
			displayToast("恭喜你随机到：其他大招之角鹰骑士！");
		}
		if(random % 8 ==4){
			displayToast("恭喜你随机到：其他大招之火山流！");
		}
		if(random % 8 ==5){
			displayToast("恭喜你随机到：其他大招之山岭弩车！");
		}
		if(random % 8 ==6){
			displayToast("恭喜你随机到：其他大招之乱矿流！");
		}
		if(random % 8 ==7){
