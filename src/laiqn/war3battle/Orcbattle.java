...
public class Orcbattle extends Activity {
	
	public static Orcbattle instance = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orcbattle);
      ...
      //��Ҫ��ҳ��ʾ��Viewװ��������
        ...
        View view1 = mLi.inflate(R.layout.activity_orcv1, null);
        View view2 = mLi.inflate(R.layout.activity_orcv2, null);
        View view3 = mLi.inflate(R.layout.activity_orcv3, null);
        View view4 = mLi.inflate(R.layout.activity_orcv4, null);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
	 ...
	 public void backv1(View view) {
		...
		public void clickv1(View view) {
			...
			if(random % 9 ==5){
				displayToast("其他大招KD+SM TR");
			}
			if(random % 9 ==6){
				displayToast("其他大招无限黑白牛");
			}
			if(random % 9 ==7){
				displayToast("其他大招FLY暴力狼骑流");
			}
			if(random % 9 ==8){
		...
		public void clickv2(View view) {
		  ...
		  public void backv3(View view) {
			...
			public void clickv3(View view) {
				...
				int random = (int)Math.round(Math.random()*100);
				if(random % 8 ==0){
					displayToast("前期压制或TR");
				}
				if(random % 8 ==1){
					displayToast("2本TR");
				}
				if(random % 8 ==2){
					displayToast("常规万金油战术");
				}
				if(random % 8 ==3){
					displayToast("双骑流");
				}
				...
				if(random % 8 ==5){
					displayToast("其他战术眩晕流");
				}
				if(random % 8 ==6){
					displayToast("其他战术3本嗜血牛头");
				}
				if(random % 8 ==7){
					displayToast("你人品太差了，什么都没随机到！");
				}
