...
public class Racesv3 extends Activity {
	
	public static Racesv3 instance = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_racesv3);
         //����activityʱ���Զ����������
      ...
      //��Ҫ��ҳ��ʾ��Viewװ��������
        ...
        View view1 = mLi.inflate(R.layout.activity_ne, null);
        View view2 = mLi.inflate(R.layout.activity_undead, null);
        View view4 = mLi.inflate(R.layout.activity_human, null);
        View view5 = mLi.inflate(R.layout.activity_orc, null);
        View view3 = mLi.inflate(R.layout.activity_neu, null);
