...
public class Racesv5 extends Activity {
	
	public static Racesv5 instance = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //��Ҫ��ҳ��ʾ��Viewװ��������
        ...
        View view2 = mLi.inflate(R.layout.activity_human, null);
        View view3 = mLi.inflate(R.layout.activity_orc, null);
        View view4 = mLi.inflate(R.layout.activity_ne, null);
        View view5 = mLi.inflate(R.layout.activity_undead, null);
        View view1 = mLi.inflate(R.layout.activity_neu, null);
