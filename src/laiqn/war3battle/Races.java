...
public class Races extends Activity {
	...
	public static Races instance = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //��Ҫ��ҳ��ʾ��Viewװ��������
        ...
        View view1 = mLi.inflate(R.layout.activity_human, null);
        View view2 = mLi.inflate(R.layout.activity_orc, null);
        View view3 = mLi.inflate(R.layout.activity_ne, null);
        View view4 = mLi.inflate(R.layout.activity_undead, null);
        View view5 = mLi.inflate(R.layout.activity_neu, null);
